...
[System.Serializable]
public class InventorySlotSaveEntry : Il2CppSystem.Object
{
	...
	static InventorySlotSaveEntry()
	{
		Il2CppClassPointerStore<InventorySlotSaveEntry>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "Core.Save", "InventorySlotSaveEntry");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<InventorySlotSaveEntry>.NativeClassPtr);
		NativeFieldInfoPtr_slotIndex = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<InventorySlotSaveEntry>.NativeClassPtr, "slotIndex");
		NativeFieldInfoPtr_itemType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<InventorySlotSaveEntry>.NativeClassPtr, "itemType");
		NativeFieldInfoPtr_registryIndex = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<InventorySlotSaveEntry>.NativeClassPtr, "registryIndex");
		NativeFieldInfoPtr_stackCount = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<InventorySlotSaveEntry>.NativeClassPtr, "stackCount");
		NativeFieldInfoPtr_contrabandId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<InventorySlotSaveEntry>.NativeClassPtr, "contrabandId");
		NativeFieldInfoPtr_photoFileName = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<InventorySlotSaveEntry>.NativeClassPtr, "photoFileName");
		NativeFieldInfoPtr_cargoBoxState = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<InventorySlotSaveEntry>.NativeClassPtr, "cargoBoxState");
		NativeFieldInfoPtr_pizzaState = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<InventorySlotSaveEntry>.NativeClassPtr, "pizzaState");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<InventorySlotSaveEntry>.NativeClassPtr, 100676026);
	}

	[CallerCount(2493)]
	[CachedScanResults(RefRangeStart = 17367, RefRangeEnd = 19860, XrefRangeStart = 17367, XrefRangeEnd = 19860, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe InventorySlotSaveEntry()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<InventorySlotSaveEntry>.NativeClassPtr))
	{
	...
	public InventorySlotSaveEntry(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
