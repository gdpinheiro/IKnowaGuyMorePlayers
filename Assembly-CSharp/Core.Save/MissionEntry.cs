...
[System.Serializable]
public class MissionEntry : Il2CppSystem.Object
{
	...
	static MissionEntry()
	{
		Il2CppClassPointerStore<MissionEntry>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "Core.Save", "MissionEntry");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<MissionEntry>.NativeClassPtr);
		NativeFieldInfoPtr_missionId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MissionEntry>.NativeClassPtr, "missionId");
		NativeFieldInfoPtr_success = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MissionEntry>.NativeClassPtr, "success");
		NativeFieldInfoPtr_score = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MissionEntry>.NativeClassPtr, "score");
		NativeFieldInfoPtr_moneyReward = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MissionEntry>.NativeClassPtr, "moneyReward");
		NativeFieldInfoPtr_xpReward = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MissionEntry>.NativeClassPtr, "xpReward");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MissionEntry>.NativeClassPtr, 100676000);
	}

	[CallerCount(2493)]
	[CachedScanResults(RefRangeStart = 17367, RefRangeEnd = 19860, XrefRangeStart = 17367, XrefRangeEnd = 19860, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe MissionEntry()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<MissionEntry>.NativeClassPtr))
	{
	...
	public MissionEntry(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
