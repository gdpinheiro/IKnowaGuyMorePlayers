...
{
	private static readonly IntPtr NativeFieldInfoPtr_mysteryPrompt;
	...
	public unsafe string mysteryPrompt
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_mysteryPrompt);
			return IL2CPP.Il2CppStringToManaged(*(IntPtr*)num);
		}
		set
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_mysteryPrompt)), IL2CPP.ManagedStringToIl2Cpp(text));
		}
	}

	static MysteryObject()
	{
		Il2CppClassPointerStore<MysteryObject>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "", "MysteryObject");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<MysteryObject>.NativeClassPtr);
		NativeFieldInfoPtr_mysteryPrompt = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MysteryObject>.NativeClassPtr, "mysteryPrompt");
		NativeMethodInfoPtr_OnInteract_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MysteryObject>.NativeClassPtr, 100668324);
		NativeMethodInfoPtr_OnLookAt_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MysteryObject>.NativeClassPtr, 100668325);
		NativeMethodInfoPtr_OnLookAway_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MysteryObject>.NativeClassPtr, 100668326);
		NativeMethodInfoPtr_GetInteractionPrompt_Public_Virtual_Final_New_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MysteryObject>.NativeClassPtr, 100668327);
		NativeMethodInfoPtr_CanInteract_Public_Virtual_Final_New_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MysteryObject>.NativeClassPtr, 100668328);
		NativeMethodInfoPtr_GetTransform_Public_Virtual_Final_New_Transform_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MysteryObject>.NativeClassPtr, 100668329);
		NativeMethodInfoPtr_GetInteractSound_Public_Virtual_Final_New_AudioClip_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MysteryObject>.NativeClassPtr, 100668330);
		NativeMethodInfoPtr_GetContextualPrompt_Public_Virtual_Final_New_String_GameObject_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MysteryObject>.NativeClassPtr, 100668331);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MysteryObject>.NativeClassPtr, 100668332);
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 92843, XrefRangeEnd = 92848, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe MysteryObject()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<MysteryObject>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public MysteryObject(IntPtr pointer)
		: base(pointer)
	{
	}
}
