...
public class RAF_CollisionMessages : RagdollAnimatorFeatureCollisions
{
	...
	public unsafe GameObject receiver
	{
		get
		{
		...
		set
		{
			...
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_receiver)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)gameObject));
		}
	}
	...
	static RAF_CollisionMessages()
	{
		Il2CppClassPointerStore<RAF_CollisionMessages>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "FIMSpace.FProceduralAnimation", "RAF_CollisionMessages");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<RAF_CollisionMessages>.NativeClassPtr);
		NativeFieldInfoPtr_receiver = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RAF_CollisionMessages>.NativeClassPtr, "receiver");
		NativeFieldInfoPtr_ignoreSelf = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RAF_CollisionMessages>.NativeClassPtr, "ignoreSelf");
		NativeFieldInfoPtr_collectCollisions = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RAF_CollisionMessages>.NativeClassPtr, "collectCollisions");
		NativeMethodInfoPtr_get_EnableCollectCollision_Public_Virtual_get_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RAF_CollisionMessages>.NativeClassPtr, 100677554);
		NativeMethodInfoPtr_OnInit_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RAF_CollisionMessages>.NativeClassPtr, 100677555);
		NativeMethodInfoPtr_OnCollisionEnterAction_Public_Virtual_Void_RA2BoneCollisionHandler_Collision_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RAF_CollisionMessages>.NativeClassPtr, 100677556);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RAF_CollisionMessages>.NativeClassPtr, 100677557);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 236813, XrefRangeEnd = 236843, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 236843, XrefRangeEnd = 236849, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe RAF_CollisionMessages()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<RAF_CollisionMessages>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public RAF_CollisionMessages(IntPtr pointer)
		: base(pointer)
	{
	}
}
