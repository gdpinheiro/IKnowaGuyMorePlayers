...
public class DebtReward : HoldableBase
{
	...
	static DebtReward()
	{
		Il2CppClassPointerStore<DebtReward>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "", "DebtReward");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<DebtReward>.NativeClassPtr);
		NativeFieldInfoPtr_itemNameKey = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DebtReward>.NativeClassPtr, "itemNameKey");
		NativeFieldInfoPtr_itemDescriptionKey = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DebtReward>.NativeClassPtr, "itemDescriptionKey");
		NativeMethodInfoPtr_GetItemNameKey_Protected_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DebtReward>.NativeClassPtr, 100665417);
		NativeMethodInfoPtr_GetItemDescriptionKey_Protected_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DebtReward>.NativeClassPtr, 100665418);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DebtReward>.NativeClassPtr, 100665419);
		NativeMethodInfoPtr___initializeVariables_Protected_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DebtReward>.NativeClassPtr, 100665420);
		NativeMethodInfoPtr___initializeRpcs_Protected_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DebtReward>.NativeClassPtr, 100665421);
		NativeMethodInfoPtr___getTypeName_FamOrAssem_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DebtReward>.NativeClassPtr, 100665422);
	}
	...
	public unsafe DebtReward()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<DebtReward>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 59222, XrefRangeEnd = 59224, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public DebtReward(IntPtr pointer)
		: base(pointer)
	{
	}
}
