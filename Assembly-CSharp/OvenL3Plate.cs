...
public class OvenL3Plate : MonoBehaviour
{
	private static readonly IntPtr NativeFieldInfoPtr_oven;

	private static readonly IntPtr NativeFieldInfoPtr_tier;

	private static readonly IntPtr NativeMethodInfoPtr_Bind_Public_Void_OvenL3_OvenL3Tier_0;
	...
	public unsafe OvenL3 oven
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<OvenL3>(intPtr) : null;
		}
		set
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_oven)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)ovenL));
		}
	}
	...
	static OvenL3Plate()
	{
		Il2CppClassPointerStore<OvenL3Plate>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "", "OvenL3Plate");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<OvenL3Plate>.NativeClassPtr);
		NativeFieldInfoPtr_oven = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OvenL3Plate>.NativeClassPtr, "oven");
		NativeFieldInfoPtr_tier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OvenL3Plate>.NativeClassPtr, "tier");
		NativeMethodInfoPtr_Bind_Public_Void_OvenL3_OvenL3Tier_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OvenL3Plate>.NativeClassPtr, 100667480);
		NativeMethodInfoPtr_OnInteract_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OvenL3Plate>.NativeClassPtr, 100667481);
		NativeMethodInfoPtr_CanInteract_Public_Virtual_Final_New_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OvenL3Plate>.NativeClassPtr, 100667482);
		NativeMethodInfoPtr_OnLookAt_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OvenL3Plate>.NativeClassPtr, 100667483);
		NativeMethodInfoPtr_GetInteractionPrompt_Public_Virtual_Final_New_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OvenL3Plate>.NativeClassPtr, 100667484);
		NativeMethodInfoPtr_GetContextualPrompt_Public_Virtual_Final_New_String_GameObject_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OvenL3Plate>.NativeClassPtr, 100667485);
		NativeMethodInfoPtr_GetInteractSound_Public_Virtual_Final_New_AudioClip_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OvenL3Plate>.NativeClassPtr, 100667486);
		NativeMethodInfoPtr_OnLookAway_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OvenL3Plate>.NativeClassPtr, 100667487);
		NativeMethodInfoPtr_GetTransform_Public_Virtual_Final_New_Transform_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OvenL3Plate>.NativeClassPtr, 100667488);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OvenL3Plate>.NativeClassPtr, 100667489);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 0, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void Bind(OvenL3 ovenRef, OvenL3Tier tierRef)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[2];
		*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)ovenRef);
		*(OvenL3Tier**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &tierRef;
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_Bind_Public_Void_OvenL3_OvenL3Tier_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 82776, XrefRangeEnd = 82781, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 82781, XrefRangeEnd = 82801, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 82801, XrefRangeEnd = 82804, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 82804, XrefRangeEnd = 82817, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe OvenL3Plate()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<OvenL3Plate>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public OvenL3Plate(IntPtr pointer)
		: base(pointer)
	{
	}
}
